...
export class Lines {
    ...
    changeSomeParamsByNodeId(nodeId, key, value) {

        this.lines = this.lines.map(i => {

            return ([i.AId, i.ZId].includes(nodeId)) ? {
    ...
    changeSomeParamsByNodeAId(nodeId, key, value) {
    ...
    changeSomeParamsByNodeZId(nodeId, key, value) {
    ...
    changeSomeParamsByLineId(lineId, key, value) {
